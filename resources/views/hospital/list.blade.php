                     ...
                     <div class="modal modal-animated--zoom-in" id="delete-modal-{{$actual->id}}">
                        ...
                        <div class="modal-content">
                           <div class="modal-body u-text-center">
                              <p>Al eliminar este hospital se eliminarán todos los doctores, incidencias y pacientes
                                 Relacionados a este ¿Está seguro?</p>
                                    <form action="{{route("hospital.destroy",$actual->id)}}" method="POST">@csrf @method("delete")<button class="btn-link">Sí</button></form>
                  ...
                  <table class="table bordered" id="tbl" width="100%">
                     <thead>
                         <tr>
                             ...
                             <th><abbr title="Dirección del hospital">Dirección</abbr></th>
                             <th><abbr title="Teléfono del hospital">Teléfono</abbr></th>
                             <th><abbr title="Acciones de registro">Acción</abbr></th>
                         </tr>
                     </thead>
                     <tbody>
                        @if (count($hospitales) > 0)
